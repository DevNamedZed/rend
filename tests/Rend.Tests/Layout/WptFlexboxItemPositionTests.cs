...
{
    public class WptFlexboxItemPositionTests
    {
        private readonly ITestOutputHelper _output;
        public WptFlexboxItemPositionTests(ITestOutputHelper output) { _output = output; }

        [Fact] public void TwoItems_Positions() {
            var r = LayoutTestHelper.Layout(@"<body style='margin:0'><div style='display:flex;width:300px'><div id='a' style='width:80px;height:30px'></div><div id='b' style='width:80px;height:30px'></div></div></body>");
        ...
        [Fact] public void ThreeItems_Positions() {
            var r = LayoutTestHelper.Layout(@"<body style='margin:0'><div style='display:flex;width:300px'><div id='a' style='width:60px;height:30px'></div><div id='b' style='width:70px;height:30px'></div><div id='c' style='width:80px;height:30px'></div></div></body>");
            Assert.True(System.Math.Abs(LayoutTestHelper.FindById(r,"a")!.ContentRect.X - 0) < 2);
        ...
        [Fact] public void FourItems_Positions() {
            var r = LayoutTestHelper.Layout(@"<body style='margin:0'><div style='display:flex;width:400px'><div id='a' style='width:50px;height:30px'></div><div id='b' style='width:50px;height:30px'></div><div id='c' style='width:50px;height:30px'></div><div id='d' style='width:50px;height:30px'></div></div></body>");
            Assert.True(System.Math.Abs(LayoutTestHelper.FindById(r,"d")!.ContentRect.X - 150) < 2);
        }

        [Fact] public void Items_With_Gap() {
        ...
        [Fact] public void Items_With_Margin() {
        ...
        [Fact] public void Column_TwoItems_YPositions() {
        ...
        [Fact] public void Column_ThreeItems_YPositions() {
        ...
        [Fact] public void Column_With_Gap() {
        ...
        [Fact] public void FlexGrow_Positions() {
        ...
        [Fact] public void Center_Position() {
        ...
        [Fact] public void FlexEnd_Position() {
        ...
        [Fact] public void AllItemsSameY() {
            var r = LayoutTestHelper.Layout(@"<body style='margin:0'><div style='display:flex;width:300px'><div id='a' style='width:50px;height:30px'></div><div id='b' style='width:50px;height:50px'></div><div id='c' style='width:50px;height:40px'></div></div></body>");
            Assert.True(System.Math.Abs(LayoutTestHelper.FindById(r,"a")!.ContentRect.Y - 0) < 2);
